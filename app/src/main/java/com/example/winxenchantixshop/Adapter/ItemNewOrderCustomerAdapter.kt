...
class ItemNewOrderCustomerAdapter(private val listItem : ArrayList<ItemNewOrder>) : RecyclerView.Adapter<ItemNewOrderCustomerAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener(object :View.OnClickListener{
            override fun onClick(v:View?) {
                ...
                val intent = Intent(v.context, NewOrderDetailActivity::class.java)
